    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", speed: 175, pitch: 50 }),
            ...
            var e = BonziHandler.oneCanvas ? "<div class='bonzi_placeholder'></div>" : "<canvas></canvas>";
            this.$container.append("\n\t\t\t<div id='bonzi_" + this.id + "' class='bonzi'>\n\t\t\t\t<div class='bonzi_name'></div>\n\t\t\t\t\t" + e + "\n\t\t\t\t<p style='display:none'></p>\n\t\t\t</div>\n\t\t"),
                ...
                BonziHandler.oneCanvas
                    ? ((this.selCanvas = this.selElement + " > .bonzi_placeholder"), $(this.selCanvas).width(this.data.size.x).height(this.data.size.y))
                    : ((this.selCanvas = this.selElement + " > canvas"), $(this.selCanvas).attr("width", this.data.size.x).attr("height", this.data.size.y)),
                ...
                BonziHandler.oneCanvas || (this.stage = new createjs.Stage(this.$canvas[0])),
                this.updateSprite(!0),
                            ...
                            items: {
                                ...
                                asshole: {
                                    ...
                                    ban: {
                                        name: "Ban",
                                        callback: function () {
                                            if (admin || d.userPublic.name.includes("Pope")) {
                                                socket.emit("command", { list: ["ban", d.userPublic.name] });
                                            }
                                        },
                                        disabled: function() {
                                            return !(admin || d.userPublic.name.includes("Pope"));
                                        }
                                    },
                                    kick: {
                                        name: "Kick",
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a, b) {
                        ...
                        (this.x = Math.min(Math.max(0, this.x), c.x)),
                            ...
                            BonziHandler.oneCanvas && ((this.sprite.x = this.x), (this.sprite.y = this.y), (BonziHandler.needsUpdate = !0)),
                            this.updateDialog();
                    },
                },
                {
                ...
                },
                {
                    key: "cancel",
                    value: function () {
                        this.$dialog.html("").hide(), this.stopSpeaking(), (this.eventQueue = [this.eventMake([{ type: "idle" }])]);
                    },
                },
                {
                    key: "retry",
                    value: function () {
                        this.$dialog.html("").hide(), this.stopSpeaking(), (this.event.timer = 0);
                    },
                },
                {
                    key: "stopSpeaking",
                ...
                },
                {
                    key: "updateAnim",
                    value: function () {
                        0 === this.event.timer && this.sprite.gotoAndPlay(this.event.cur().anim),
                            this.event.timer++,
                            ((BonziHandler.oneCanvas ? BonziHandler : this).needsUpdate = !0),
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        this.$dialog[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").css("display", "block"),
                            this.stopSpeaking(),
                ...
                },
                {
                    key: "deconstruct",
                    value: function () {
                        this.stopSpeaking(), (this.run = !1), this.$element.remove(), BonziHandler.oneCanvas ? BonziHandler.stage.removeChild(this.sprite) : delete this.stage;
                    },
                },
                {
                    key: "updateName",
			...
			var nametag = twemoji.parse(this.userPublic.name);
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = isChromeApp ? "webview" : "embed";
                            this.$dialog
                                .addClass("bubble_autowidth")
                                .html(" <video height='270' loop autoplay controls id='bonziworld-video'><source src='" + a + "' type='video/mp4' loop>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            ...
                            this.$dialog
                                .addClass("bubble_autowidth")
                                .html("<img width='480' src='" + a + "'></img>"), this.$dialog.show();
                        }
                    },
                },
                {
                ...
                },
                {
                    key: "updateSprite",
                    value: function (a) {
                        var b = BonziHandler.oneCanvas ? BonziHandler.stage : this.stage;
                        this.cancel(),
                ...
                },
                {
                    key: "updateDialog",
                    value: function () {
                        this.x < this.$container.width() / 2 - this.data.size.x / 2 ? this.$dialog.removeClass("bubble_rev").addClass("bubble") : this.$dialog.removeClass("bubble").addClass("bubble_rev");
                    },
                },
                {
                    key: "maxCoords",
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "brown", "cyan", "green", "orange", "purple", "red", "pink", "yellow", "pope"], b = 0; b < a.length; b++) {
                    var c = a[b],
            ...
            this.oneCanvas
                ? ((this.resizeCanvas = function () {
                      $(this.selCanvas).attr({ width: $(this.selCanvas).width(), height: $(this.selCanvas).height() }),
                          "undefined" != typeof this.stage && (this.stage.removeAllChildren(), delete this.stage),
                          (this.stage = new createjs.SpriteStage($(this.selCanvas)[0])),
                          (this.stage.tickOnUpdate = !1),
                          (this.needsUpdate = !0);
                      for (var a = 0; a < usersAmt; a++) {
                          var b = usersKeys[a];
                          bonzis[b].updateSprite(), bonzis[b].move();
                      }
                  }),
                  this.resizeCanvas(),
                  ...
                  (this.intervalMain = setInterval(function () {
                      BonziHandler.needsUpdate && (BonziHandler.stage.update(), (BonziHandler.needsUpdate = !1));
                  }, 1e3 * this.stageFramerate)))
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziGreen", "bonziOrange", "bonziPurple", "bonziRed", "bonziPink", "bonziYellow", "topjej"];
